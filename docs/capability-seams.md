...
| `ctx.sshHosts` | `core` | [`ssh-hosts`](../packages/ssh/ssh-hosts) | - | [`tool-ssh`](../packages/ssh/tool-ssh), [`client-ui-ssh`](../packages/client/ui-ssh) | - | Owns the saved host list and remote management API used by the SSH tools and Web settings. |
