 ...
 * mirror of `@deepseek-ai/dsh-pwsh-sandbox/src/helpers.ts` (the Git Bash twin
 * shares the identical classification dialect; the win32 chain supplies the
 * signatures and rules per confinement wrap).
 *
 * @module @deepseek-ai/dsh-gitbash-sandbox/helpers
 */
