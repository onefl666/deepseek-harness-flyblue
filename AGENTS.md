...
packages/    @deepseek-ai/dsh-<pkg> workspaces at packages/<group>/<pkg>/
  ...
  ssh/                  SSH execution and host-list plugins
...
- **No hardcoded tunables in plugins**: tunables use validated `Config` in cordis.yml; constants and test hooks do not count. Protocol constants, external specs, and security invariants stay fixed.
