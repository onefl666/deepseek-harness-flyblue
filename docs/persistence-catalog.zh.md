...
来源：[`packages/plan/plan-mode/src/types.ts:55`](../packages/plan/plan-mode/src/types.ts)
...
来源：[`packages/plan/plan-mode/src/types.ts:50`](../packages/plan/plan-mode/src/types.ts)
...
来源：[`packages/plan/plan-mode/src/types.ts:46`](../packages/plan/plan-mode/src/types.ts)
...
来源：[`packages/plan/plan-mode/src/types.ts:15`](../packages/plan/plan-mode/src/types.ts)
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `execution` | 必需 | [`PlanExecution`](#persistence-type-sha256-c19b79f7b6313fdf601aab59b7346c8052f2b81733c41e348502cf576d652c32) |
| `title` | 必需 | `string` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ execution, title }`](#persistence-type-sha256-59b93f76e4782ecf093ab8a3d50204dc4d404dfc461c75bc5d379fac33d69055) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"plan/approved"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ childSessionId, mode }`](#persistence-type-sha256-809347c065347a87f6959207f88771db764041df01ecd66879f9b9eea9ebbdb5) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"plan/handoff"` |
