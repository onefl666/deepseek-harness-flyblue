...
| `Tooltip` | Hover text or content on a cloned anchor, placed right, bottom, or top. A node label carries chart detail; optional `portal` rendering escapes clipping containers and ancestor stacking contexts. |
