...
| `Tooltip` | Hover text or content on a cloned anchor, placed right, bottom, or top. A node label carries chart hover detail; the bubble never takes pointer events. |
