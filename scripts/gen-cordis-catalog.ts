...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  GitBranchEntry: 'workspace Git branch roster is owned by packages/workspace/workspace-git/README.md',
  GitGraphEntry: 'workspace Git graph row is owned by packages/workspace/workspace-git/README.md',
  GitGraphView: 'workspace Git graph read is owned by packages/workspace/workspace-git/README.md',
  GitStatusEntry: 'workspace Git status row is owned by packages/workspace/workspace-git/README.md',
  SshHost: 'secret-bearing SSH host record is owned by packages/ssh/ssh-hosts/README.md',
  SshHostId: 'SSH host identity is owned by packages/ssh/ssh-hosts/README.md',
  SshHostSummary: 'secret-free SSH host projection is owned by packages/ssh/ssh-hosts/README.md',
  ...
  McpStatusReport: 'event payload contract is owned by packages/mcp/mcp-client/src/types.ts',
