...
The published V4 migration keeps the [released V3 vocabulary](../packages/session/session-format-v3-to-v4/src/extension-identities.ts) frozen and independent of current V4 additions. Fork-specific required V3 plan events are validated separately before migration.
...
evidenceTag: dsh-v0.1.7-rc.1
```

Evidence: published product tag `dsh-v0.1.7-rc.1`; tagged writer: `packages/core/session/src/types.ts`.
