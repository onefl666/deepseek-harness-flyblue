...
来源： [`packages/codegraph/codegraph-index/src/index.ts:25`](../packages/codegraph/codegraph-index/src/index.ts)
...
Depends on: [`LocalConfig`](#deepseek-aidsh-bash-local) · `Volatile` (`@deepseek-ai/cordis`)
...
Depends on: [`LocalConfig`](#deepseek-aidsh-gitbash-local)
...
来源： [`packages/mcp/mcp-client/src/index.ts:141`](../packages/mcp/mcp-client/src/index.ts)
