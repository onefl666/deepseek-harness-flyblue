...
<!-- BEGIN GENERATED config-catalog:@deepseek-ai/dsh-codegraph-index -->
...
- `inject`: `sessions`
- `refs`: `Volatile` (`@deepseek-ai/cordis`)
- `source`: [`packages/codegraph/codegraph-index/src/index.ts:25`](../packages/codegraph/codegraph-index/src/index.ts)
...
```
<!-- END GENERATED config-catalog:@deepseek-ai/dsh-codegraph-index -->
...
<!-- BEGIN GENERATED config-catalog:@deepseek-ai/dsh-gitbash-local -->
<a id="deepseek-aidsh-gitbash-local"></a>

## `@deepseek-ai/dsh-gitbash-local`

- `refs`: [`LocalConfig`](#deepseek-aidsh-bash-local) · `Volatile` (`@deepseek-ai/cordis`)
- `source`: [`packages/shell/gitbash-local/src/index.ts:27`](../packages/shell/gitbash-local/src/index.ts)
...
```
<!-- END GENERATED config-catalog:@deepseek-ai/dsh-gitbash-local -->

<!-- BEGIN GENERATED config-catalog:@deepseek-ai/dsh-gitbash-sandbox -->
<a id="deepseek-aidsh-gitbash-sandbox"></a>

## `@deepseek-ai/dsh-gitbash-sandbox`

- `inject`: `subprocess` · `sandbox` · `sandboxPolicy`
- `refs`: [`LocalConfig`](#deepseek-aidsh-gitbash-local)
- `source`: [`packages/shell/gitbash-sandbox/src/index.ts:40`](../packages/shell/gitbash-sandbox/src/index.ts)
...
export type Config = LocalConfig
```
<!-- END GENERATED config-catalog:@deepseek-ai/dsh-gitbash-sandbox -->
...
- `inject`: `tools`
- `source`: [`packages/mcp/mcp-manager/src/index.ts:52`](../packages/mcp/mcp-manager/src/index.ts)
...
- `source`: [`packages/plan/plan-mode/src/index.ts:85`](../packages/plan/plan-mode/src/index.ts)
...
<!-- BEGIN GENERATED config-catalog:@deepseek-ai/dsh-skill-manager -->
<a id="deepseek-aidsh-skill-manager"></a>

## `@deepseek-ai/dsh-skill-manager`

- `source`: [`packages/skill/skill-manager/src/index.ts:35`](../packages/skill/skill-manager/src/index.ts)
...
```
<!-- END GENERATED config-catalog:@deepseek-ai/dsh-skill-manager -->
...
<!-- BEGIN GENERATED config-catalog:@deepseek-ai/dsh-task-board -->
...
```
<!-- END GENERATED config-catalog:@deepseek-ai/dsh-task-board -->
...
<!-- BEGIN GENERATED config-catalog:@deepseek-ai/dsh-usage-stats -->
...
```
<!-- END GENERATED config-catalog:@deepseek-ai/dsh-usage-stats -->
...
<!-- BEGIN GENERATED config-catalog:@deepseek-ai/dsh-workspace-files -->
...
```
<!-- END GENERATED config-catalog:@deepseek-ai/dsh-workspace-files -->

<!-- BEGIN GENERATED config-catalog:@deepseek-ai/dsh-workspace-git -->
...
```
<!-- END GENERATED config-catalog:@deepseek-ai/dsh-workspace-git -->
...
| `@deepseek-ai/dsh-client-ui-windows-shell` | — | [`packages/client/ui-windows-shell/src/index.ts`](../packages/client/ui-windows-shell/src/index.ts) |
...
| `@deepseek-ai/dsh-command-codegraph-init` | `commands` · `codegraphIndex` | [`packages/codegraph/command-codegraph-init/src/index.ts`](../packages/codegraph/command-codegraph-init/src/index.ts) |
...
| `@deepseek-ai/dsh-tool-ssh` | `tools` | [`packages/ssh/tool-ssh/src/index.ts`](../packages/ssh/tool-ssh/src/index.ts) |
...
| `@deepseek-ai/dsh-windows-shell` | — | [`packages/shell/windows-shell/src/index.ts`](../packages/shell/windows-shell/src/index.ts) |
