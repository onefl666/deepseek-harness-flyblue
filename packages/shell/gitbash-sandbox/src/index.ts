 ...
 * @module @deepseek-ai/dsh-gitbash-sandbox
 */
...
import type { Config as LocalConfig } from '@deepseek-ai/dsh-gitbash-local'
...
export class SandboxGitBashExecutor extends GitBashExecutor {
  ...
  // ctx.sandboxPolicy, so this executor inherits GitBashExecutor's Config
...
export default SandboxGitBashExecutor
