...
const TOOL_PACKAGES: ToolPackage[] = [
  ...
  },
  {
    ...
    note:
      'exit_plan_mode stays in the model-facing schema while planning is inactive so transitions add no tool-catalog churn on top of the plan-policy change. Its execute path rejects calls outside plan mode; in plan mode it presents execute in a fresh session, compact context, keep context, and refine choices over the user-questions seam. Approval logs plan mode inactive at the step boundary.',
  },
  {
