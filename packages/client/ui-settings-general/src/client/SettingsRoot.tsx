...
import {
  ...
  IconPersonalizationOutlineMedium, IconSettingsOutlineMedium, IconUserOutlineMedium, IconCodeOutlineMedium,
...
function navIcon(id: string) {
  ...
  if (id === 'models' || id === 'usage-stats') return <IconDataOutlineMedium className={css.navIcon} size={16} />
  if (id === 'codegraph') return <IconCodeOutlineMedium className={css.navIcon} size={16} />
