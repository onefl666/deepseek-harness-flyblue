...
export const en = {
  ...
  'error.unavailable': 'Model selection is unavailable for this session.',
  ...
  'planReview.label': 'Execution model and reasoning',
